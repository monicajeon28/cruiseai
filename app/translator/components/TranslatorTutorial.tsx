...
const STEPS = [
  ...
  },
  {
    ...
    description: '자주 쓰는 말을 버튼으로 준비했어요. 상황별 번역 도우미에서 카테고리를 선택하고 문장을 클릭하세요.',
    emoji: '⚡',
  },
  {
    title: '언어를 선택하면 해당 언어로 번역됩니다',
    description: '상단에서 여행지 언어를 선택하면 해당 언어로 번역됩니다. 각 언어별로 준비된 빠른 문장도 사용할 수 있어요.',
    emoji: '🌍',
  },
];
