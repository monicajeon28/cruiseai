          ...
          if (saved) {
            try {
              ...
              if (Array.isArray(localExpenses)) {
                ...
                logger.log('[Statistics] Loaded from localStorage:', localExpenses.length, 'items');
              }
            } catch (e) {
      ...
      if (typeof window !== 'undefined') {
        ...
        if (saved) {
          try {
            ...
            if (Array.isArray(localExpenses)) {
              setExpenses(localExpenses);
              logger.log('[Statistics] Loaded from localStorage (fallback):', localExpenses.length, 'items');
            }
          } catch (e) {
            logger.error('[Statistics] Error parsing localStorage:', e);
          }
